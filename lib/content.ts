...
export const instructors = [
  {
    ...
    specialties: ["Hatha Yoga", "Pranayama", "Prenatal Yoga", "Yoga Therapy", "Ladies Classes"],
    certifications: ["E-RYT 500 — Yoga Alliance USA", "YACEP — Yoga Alliance", "ISO 9001:2015 Certified Studio", "MSME Registered"],
    bio: "S. Maheswari is the Founder and Director of Mokshaa Yoga and one of Chennai's most respected yoga acharyas. With over a decade of dedicated teaching and a coveted E-RYT 500 certification from Yoga Alliance USA, she brings deep expertise in Hatha yoga, Pranayama and prenatal practice. Her teaching philosophy centres on creating a safe, nurturing environment where students of every level — especially beginners and women — feel genuinely supported. Maheswari leads the studio's exclusive ladies batches, prenatal programme and therapeutic yoga sessions, and is the primary contact for the studio.",
    shortBio: "E-RYT 500 certified yoga acharya and Founder of Mokshaa Yoga. Specialises in Hatha, Pranayama and Prenatal yoga.",
  ...
  },
  {
    ...
    specialties: ["Ashtanga Yoga", "Power Yoga", "Meditation", "Pranayama", "Corporate Wellness"],
    certifications: ["E-RYT 500 — Yoga Alliance USA", "YACEP — Yoga Alliance", "ISO 9001:2015 Certified Studio", "MSME Registered"],
    bio: "S. Satheesh is the Co-Founder and Managing Director of Mokshaa Yoga and a certified E-RYT 500 yoga acharya. With a background spanning Ashtanga yoga, power yoga and meditation, he brings a dynamic, disciplined energy to every class. Satheesh leads group classes, corporate yoga programmes and specialised therapeutic sessions, and is known for his ability to help students build real strength and focus without ego or pressure. His approach is direct, encouraging and rooted in authentic yoga tradition.",
    shortBio: "E-RYT 500 certified yoga acharya and Co-Founder of Mokshaa Yoga. Specialises in Ashtanga, Power Yoga and Meditation.",
    experience: "10+ years teaching",
...
export const trustStats = [
  ...
  { value: "7", label: "Class formats" },
  { value: "E-RYT 500", label: "Yoga Alliance certified" },
] as const;
